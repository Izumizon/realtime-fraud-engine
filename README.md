...
The ADRs explain key design choices, including why the project uses Redis for hot fraud state, Kafka for event streaming, and PostgreSQL for the transaction ledger.
